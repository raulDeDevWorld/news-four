...
function TemplateOne() {
  ...
  useEffect(() => {
    ...
    userDB && userDB[validate()] && postsIMG[`${validate()}/PostImage_${router.query.temporal.slice(2)}`] == undefined ? getIndexStorage(validate(), userDB[validate()].Posts, postsIMG, setUserPostsIMG) : ''
    ...
    <Layout>
      ...
      {specificData && <main className={styles.main}>
        ...
        <div className={styles.adds}>
          ...
          <BannerNotas carpeta="BannerNotas" items={[1, 2,]} click={handlerClickEnlace}></BannerNotas>
